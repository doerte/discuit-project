...
git branch -M main
git remote add origin git@github.com:doerte/discuit-project
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/doerte/repositories/new](https://github.com/organizations/doerte/repositories/new)
and create a new repository named `discuit-project` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:doerte/discuit-project/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
