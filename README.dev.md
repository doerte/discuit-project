...
Don't forget to also make a [release on GitHub](git@github.com:doerte/discuit-project/releases/new). If your repository uses the GitHub-Zenodo integration this will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
